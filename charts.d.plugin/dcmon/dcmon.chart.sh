...
dcmon_get() {
	...
	response=$(curl -s "http://dcmon.datacenter.uoc.gr/feed/list.json?userid=1")
	
	# HVAC Board
	dcmon_RphaseWatts=$(printf '%.2f' $(echo $response | jq '. [0] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_SphaseWatts=$(printf '%.2f' $(echo $response | jq '. [1] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_TphaseWatts=$(printf '%.2f' $(echo $response | jq '. [2] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_RphaseIrms=$(printf '%.2f' $(echo $response | jq '. [3] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_SphaseIrms=$(printf '%.2f' $(echo $response | jq '. [4] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_TphaseIrms=$(printf '%.2f' $(echo $response | jq '. [5] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_RphaseKiloWattHours=$(printf '%.2f' $(echo $response | jq '. [6] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_SphaseKiloWattHours=$(printf '%.2f' $(echo $response | jq '. [7] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_TphaseKiloWattHours=$(printf '%.2f' $(echo $response | jq '. [8] .value' | sed -e 's/"//g') | sed -e 's/\.//g')

	# Board "A"
	dcmon_RphaseWattsA=$(printf '%.2f' $(echo $response | jq '. [18] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_SphaseWattsA=$(printf '%.2f' $(echo $response | jq '. [19] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_TphaseWattsA=$(printf '%.2f' $(echo $response | jq '. [20] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_RphaseIrmsA=$(printf '%.2f' $(echo $response | jq '. [12] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_SphaseIrmsA=$(printf '%.2f' $(echo $response | jq '. [13] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_TphaseIrmsA=$(printf '%.2f' $(echo $response | jq '. [14] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_RphaseKiloWattHoursA=$(printf '%.2f' $(echo $response | jq '. [21] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_SphaseKiloWattHoursA=$(printf '%.2f' $(echo $response | jq '. [22] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
	dcmon_TphaseKiloWattHoursA=$(printf '%.2f' $(echo $response | jq '. [23] .value' | sed -e 's/"//g') | sed -e 's/\.//g')

        # Board "B"
        dcmon_RphaseWattsB=$(printf '%.2f' $(echo $response | jq '. [15] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_SphaseWattsB=$(printf '%.2f' $(echo $response | jq '. [16] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_TphaseWattsB=$(printf '%.2f' $(echo $response | jq '. [17] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_RphaseIrmsB=$(printf '%.2f' $(echo $response | jq '. [9] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_SphaseIrmsB=$(printf '%.2f' $(echo $response | jq '. [10] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_TphaseIrmsB=$(printf '%.2f' $(echo $response | jq '. [11] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_RphaseKiloWattHoursB=$(printf '%.2f' $(echo $response | jq '. [24] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_SphaseKiloWattHoursB=$(printf '%.2f' $(echo $response | jq '. [25] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
        dcmon_TphaseKiloWattHoursB=$(printf '%.2f' $(echo $response | jq '. [26] .value' | sed -e 's/"//g') | sed -e 's/\.//g')
